package com.example.malwainstute.otp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }else if(edtPhone.length()<6){
                    edtPhone.setError("at least 10 digits.");
                } else {
                    firebaseDatabase=FirebaseDatabase.getInstance();
                    databaseReference=firebaseDatabase.getReference("datauser");

                    Query check_username=databaseReference.orderByChild("phone").equalTo(edtPhone.getText().toString());
        ...
        verifyOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtOTP.getText().toString())) {
                    edtOTP.setError("Please enter a valid phone number.");
                } else {
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(Otp.this, RegisterPage.class);
                            i.putExtra("phoneno",s);
                            startActivity(i);
                            finish();
                        } else {
